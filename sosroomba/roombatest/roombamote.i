...
# 1 "roombamote.h" 1
# 18 "roombamote.c" 2
# 1 "../roombacomm/roombacomm.h" 1
# 28 "../roombacomm/roombacomm.h"
typedef struct {
    int16_t velocity;
    uint8_t pid;
    uint8_t state;
...
# 29 "roombamote.c"
typedef struct {
    func_cb_ptr roombacomm_Start; func_cb_ptr roombacomm_Control; func_cb_ptr roombacomm_Stop; func_cb_ptr roombacomm_Reset; func_cb_ptr roombacomm_GoStraightAt; func_cb_ptr roombacomm_GoStraightFor; func_cb_ptr roombacomm_SpinLeftAt; func_cb_ptr roombacomm_SpinLeftFor; func_cb_ptr roombacomm_SpinRightAt; func_cb_ptr roombacomm_SpinRightFor;;
...
uint8_t stop_cmd[5] = {0x89, 0x0, 0x0, 0x0, 0x0};
# 66 "roombamote.c"
...
static mod_header_t mod_header __attribute__ ((__progmem__)) = {
    ...
    .funct = { [0] = {error_8, "cvv0", DFLT_APP_ID1, ROOMBACOMM_START_FID}, [1] = {error_8, "cvv0", DFLT_APP_ID1, ROOMBACOMM_CONTROL_FID}, [2] = {error_8, "cvv0", DFLT_APP_ID1, ROOMBACOMM_STOP_FID}, [3] = {error_8, "cvv0", DFLT_APP_ID1, ROOMBACOMM_RESET_FID}, [4] = {error_8, "ccv1", DFLT_APP_ID1, ROOMBACOMM_GOSTRAIGHTAT_FID}, [5] = {error_8, "ccv1", DFLT_APP_ID1, ROOMBACOMM_GOSTRAIGHTFOR_FID}, [6] = {error_8, "ccv1", DFLT_APP_ID1, ROOMBACOMM_SPINLEFTAT_FID}, [7] = {error_8, "ccv1", DFLT_APP_ID1, ROOMBACOMM_SPINLEFTFOR_FID}, [8] = {error_8, "ccv1", DFLT_APP_ID1, ROOMBACOMM_SPINRIGHTAT_FID}, [9] = {error_8, "ccv1", DFLT_APP_ID1, ROOMBACOMM_SPINRIGHTFOR_FID},
    }
};
        ...
        case MSG_TIMER_TIMEOUT:
            {
                ...
                if (params->byte == 0)
                {
                    ker_uart_reserve_bus(s->pid, 0x40);
        ...
        case (MOD_MSG_START + 3):
            {
                ...
                if (s->buff_to_send != ((void *)0)){
                    if (s->buff_to_send[0] == 0x89 && msg_len == 7) {
        ...
        case MSG_UART_SEND_DONE:
            {
                ...
                post_net(s->pid, s->pid, (MOD_MSG_START + 4), 1, &s->ackbyte, SOS_MSG_RELIABLE, 0xFFFF);
                ker_led(6);
                if (s->ptime > 0) {
                    sys_timer_start(0, s->ptime, TIMER_ONE_SHOT);
                    s->ptime = 0;
                    ker_led(2);
                }
