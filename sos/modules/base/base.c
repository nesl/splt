...
static int8_t base_msg_handler(void *start, Message *e);
...
static const mod_header_t mod_header SOS_MODULE_HEADER = {
	...
	.module_handler = base_msg_handler,
};


static int8_t base_msg_handler(void *state, Message *msg)
{
  /**
  ...
  post_uart(msg->sid,msg->did,msg->type,msg->len,msg->data,SOS_MSG_RELEASE,UART_ADDRESS);
  /**
...
#ifndef _MODULE_
mod_header_ptr base_get_header()
{
